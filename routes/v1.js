...
app.post('/recurso', gradoController.create);
app.put('/recurso/:id',  gradoController.update);
app.delete('/recurso/:id',  gradoController.delete);
app.get('/recurso/:id',  gradoController.getOne);
app.get('/recurso/search/:param',  gradoController.search);
